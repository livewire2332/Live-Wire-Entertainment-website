...
style.textContent+=`
.lw-coin-slot{position:absolute;top:8px;left:50%;transform:translateX(-50%);padding:5px 12px;border:2px solid #00eaff;border-radius:12px;color:#58eaff;font-weight:900;background:#050914}.lw-coin-pile{width:84%;height:75%;left:8%;bottom:12%;transform:none}.lw-loose-coin{position:absolute;display:block;font-size:23px;filter:drop-shadow(0 0 5px rgba(255,210,31,.65));transition:left .35s ease}.lw-falling-coin{bottom:72%;animation:lwCoinDrop .5s ease-in forwards}.lw-coin-pusher-arm{position:absolute;left:8%;right:8%;bottom:36%;height:7px;background:#58eaff;box-shadow:0 0 12px #58eaff;animation:lwPusherMove 1.4s ease-in-out infinite}.lw-coin-payout{text-align:center;position:absolute;bottom:2%;left:0;right:0;color:#ffd21f;font-weight:1000}.lw-coin-aim{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.lw-coin-range{flex:1;min-width:130px}.lw-coin-aim button{flex:1;min-width:120px}@keyframes lwCoinDrop{to{bottom:31%;transform:rotate(360deg)}}
.lw-killer-board{position:relative;overflow:hidden}.lw-killer-numbers{position:absolute;inset:8px;display:flex;flex-wrap:wrap;justify-content:center;align-content:center;gap:7px}.lw-killer-number{width:42px;height:42px;border-radius:50%;border:2px solid #ffd21f;background:#080b18;color:#fff;font-weight:1000;box-shadow:0 0 8px rgba(255,210,31,.35)}.lw-killer-dart{position:absolute;left:50%;top:50%;font-size:28px;transform:translate(-50%,-50%);z-index:4}.lw-killer-dart.fly{animation:lwDartFly .5s ease-in forwards}.lw-killer-controls{display:flex;gap:8px;flex-wrap:wrap}.lw-killer-controls button{flex:1;min-width:110px}@keyframes lwDartFly{to{left:78%;top:43%;transform:translate(-50%,-50%) rotate(18deg)}}
.lw-bull-board{position:relative;width:min(100%,340px);aspect-ratio:1;margin:15px auto;border-radius:50%;background:radial-gradient(circle,#ff334d 0 9%,#111 10% 17%,#00eaff 18% 28%,#111 29% 42%,#ff2bd6 43% 57%,#111 58% 72%,#ffd21f 73% 100%);box-shadow:0 0 30px rgba(0,234,255,.3);touch-action:none;overflow:hidden}.lw-bull-ring{position:absolute;border:2px solid rgba(255,255,255,.35);border-radius:50%;inset:15%}.lw-bull-ring.r2{inset:30%}.lw-bull-ring.r3{inset:43%}.lw-bull-centre{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font-size:25px}.lw-aim-dart{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font-size:25px;z-index:3;filter:drop-shadow(0 0 7px #fff)}.lw-bull-actions{display:flex;gap:8px}.lw-bull-actions button{flex:1}
.lw-skittle-stage{touch-action:none}.lw-skittle-pin{position:absolute;transform:translate(-50%,-50%);font-size:26px;filter:drop-shadow(0 0 5px rgba(255,255,255,.4))}.lw-skittle-ball{touch-action:none;left:50%!important}.lw-skittle-actions{display:flex;gap:8px}.lw-skittle-actions button{flex:1}
.lw-shuffle-lane{touch-action:none}.lw-shuffle-puck.dragging{transform:translateX(-50%) scale(1.15);filter:drop-shadow(0 0 12px #ffd21f)}.lw-shuffle-reset{width:100%}
.lw-mystery-card{touch-action:manipulation}.lw-fruit-lever{height:125px;width:80px;margin:12px auto;position:relative;cursor:grab;touch-action:none}.lw-fruit-track{position:absolute;left:35px;top:8px;width:10px;height:110px;border-radius:10px;background:#171b2d;border:2px solid #00eaff}.lw-fruit-handle{position:absolute;z-index:2;left:17px;top:5px;width:46px;height:46px;border-radius:50%;display:grid;place-items:center;background:#ff2bd6;border:3px solid #ffd21f;box-shadow:0 0 18px rgba(255,43,214,.65);transition:top .25s ease}.lw-fruit-handle.pulled{top:70px}.lw-fruit-lever:active{cursor:grabbing}
@media(max-width:600px){.lw-killer-number{width:38px;height:38px}.lw-killer-controls button,.lw-bull-actions button,.lw-skittle-actions button{min-width:0;font-size:13px}.lw-coin-aim{display:grid;grid-template-columns:1fr 1fr}.lw-coin-range{grid-column:1/-1;width:100%}}
`;
